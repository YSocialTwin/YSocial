...
def _lazy_llm_helpers():
    ...
    return is_ollama_installed, is_ollama_running, is_vllm_installed, is_vllm_running
...
def ollama_status():
    ...
    """
    is_ollama_installed, is_ollama_running, _, _ = _lazy_llm_helpers()
...
def llm_backend_status():
    ...
    if ":" in backend and backend not in ["ollama", "vllm"]:
        ...
        _, _, is_vllm_installed, is_vllm_running = _lazy_llm_helpers()
