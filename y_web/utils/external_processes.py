...
# Dictionary to track Ollama model download processes — defined in src/llm/ollama_manager
# (imported below when ollama functions are delegated)
...
# Server env/screen helpers — delegated to y_web.src.simulation.server
# fmt: off
...
# Port management — delegated to y_web.src.simulation.port_manager
# fmt: off
...
# Legacy double-underscore alias used by terminate_server_process below
__terminate_process = _terminate_process


# Server termination — delegated to y_web.src.simulation.server
# fmt: off
