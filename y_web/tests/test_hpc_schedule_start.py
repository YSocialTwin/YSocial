...
def test_start_schedule_calls_start_hpc_server_for_hpc_experiments():
    ...
    with (
        ...
        mock_group_cls.query.filter.return_value.order_by.return_value.first.return_value = (
            mock_group
        )
