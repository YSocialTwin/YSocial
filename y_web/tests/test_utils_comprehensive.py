...
class TestUtilsModuleStructure:
    ...
    def test_utils_init_exports(self):
        ...
        try:
            from y_web.utils import agents
            from y_web.utils import feeds  
            from y_web.utils import external_processes
            from y_web.utils import miscellanea
...
class TestUtilsIntegration:
    ...
    def test_database_utils_integration(self):
        ...
        try:
            from y_web.utils.miscellanea import get_db_type, get_db_port, check_connection
    ...
    def test_ollama_utils_integration(self):
        ...
        try:
            from y_web.utils.miscellanea import ollama_status, get_ollama_models
