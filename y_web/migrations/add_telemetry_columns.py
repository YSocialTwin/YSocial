"""
Database migration script to add telemetry columns to admin_users table.

This script adds:
- telemetry_enabled: Boolean column (default True)
- telemetry_notice_shown: Boolean column (default False)
