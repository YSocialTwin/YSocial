...
| [Synchronous Progression](multi-platform-simulations/08-synchronous-progression.md) | synchronization challenges, centralized group barrier, and recovery plan |
...
8. [Synchronous Progression](multi-platform-simulations/08-synchronous-progression.md)
...
- Use the synchronous progression doc to plan time synchronization across heterogeneous platforms.
